...
lenis={}
lenis["CNT"] = np.array([192, 192, 192, 192, 192, 192, 192, 192, 192, 192, 192, 192, 192])
lenis["MCS"] = np.array([192, 192, 192, 192, 192, 175, 175, 175, 175, 175, 175, 175, 175, 175, 175, 175, 175, 175, 175, 175, 175, 195, 195, 195, 195])
lenis["UWS"] = np.array([192, 192, 192, 192, 192, 192, 192, 192, 175, 175, 175, 175, 175, 175, 175, 175, 175, 175, 195, 195])
...
to_save = {}
to_save["prelabels"] = prelabels
to_save["labels"] = labels
to_save["ordd"] = ordd
to_save["cors_sorted"] = cors
to_save["emes_sorted"] = emes
to_save["lenis_CNT"] = lenis["CNT"]
to_save["lenis_MCS"] = lenis["MCS"]
to_save["lenis_UWS"] = lenis["UWS"]

np.savez_compressed("data/clustering_output.npz",**to_save)
